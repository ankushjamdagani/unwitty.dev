  ...
  return (
    <ul className="group absolute inset-0">
      {list.map((image) => (
        <li
          key={image.alt}
          className="bg-canvas-contrast rounded border-fg-contrast hover:z-base themed-filter absolute left-0 right-0 mx-auto aspect-[1/1.5] w-[240px] cursor-pointer p-4 transition-all duration-[250ms] origin-bottom-left border-2 border-dashed hover:-translate-y-5

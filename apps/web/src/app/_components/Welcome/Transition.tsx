...
export function Transition({ selected }: TransitionProps) {
  ...
  return (
    <>
      ...
      />
      <div
        className={`fixed inset-0 z-[60] flex items-center justify-center pointer-events-none text-center font-mono-display text-xs font-medium leading-[1.6] tracking-[0.18em] text-fg [transition:opacity_0.35s_ease_0.25s] ${on ? "opacity-100" : "opacity-0"}`}
      >
        <div>
